...
public class ModAnimations {
	...
	public static final Animation BREEZE_IDE = Animation.Builder.withLength(1.5F).looping()
		...
		.addPartAnimation("head", new PartAnimation(PartAnimation.AnimationTargets.TRANSLATE,
			new AnimationKeyframe(0.0F, Animator.translate(0.0F, 0.0F, -0.25F), PartAnimation.Interpolations.LINEAR),
			new AnimationKeyframe(0.75F, Animator.translate(0.0F, 1.25F, 0.5F), PartAnimation.Interpolations.SPLINE),
			new AnimationKeyframe(1.5F, Animator.translate(0.0F, 0.0F, -0.25F), PartAnimation.Interpolations.LINEAR)
		))
		...
		.addPartAnimation("6", new PartAnimation(PartAnimation.AnimationTargets.ROTATE,
			new AnimationKeyframe(0.0F, Animator.rotate(0.0F, 0.0F, 0.0F), PartAnimation.Interpolations.LINEAR)
		))
		.addPartAnimation("6", new PartAnimation(PartAnimation.AnimationTargets.SCALE,
			new AnimationKeyframe(0.0F, Animator.scale(0.9F, 1.0F, 0.9F), PartAnimation.Interpolations.LINEAR)
		))
