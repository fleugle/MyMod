...
public enum ModToolMaterial implements ToolMaterial {
	...
	BREEZE_ROD(0, 500,0f, 7, 10, () -> Ingredient.ofItems(ModItems.BREEZE_ROD)),
	TRIUMPH_OF_JUSTICE(0, 10,0f, 7, 10, () -> Ingredient.ofItems(ModItems.BREEZE_ROD));//put comma to add new
