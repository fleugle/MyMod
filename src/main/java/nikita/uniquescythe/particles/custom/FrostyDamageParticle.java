...
public class FrostyDamageParticle extends SpriteBillboardParticle {
	FrostyDamageParticle(ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
	...
	public static class DefaultFactory implements ParticleFactory<DefaultParticleType> {
		...
		public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
			FrostyDamageParticle damageParticle = new FrostyDamageParticle(clientWorld, d, e, f, g, h + 1.0, i);
	...
	public static class EnchantedHitFactory implements ParticleFactory<DefaultParticleType> {
		...
		public Particle createParticle(DefaultParticleType defaultParticleType, ClientWorld clientWorld, double d, double e, double f, double g, double h, double i) {
			FrostyDamageParticle damageParticle = new FrostyDamageParticle(clientWorld, d, e, f, g, h, i);
